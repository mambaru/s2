...
*/
    public static function stToUV($s)
    {
        switch (self::S2_PROJECTION) {
            ...
            default:
                throw new \RuntimeException("Invalid value for S2_PROJECTION");
        }
    }
     ...
     * @param int $face
     * @param S2Point $p
     * @return null|R2Vector
     */
    public static function faceXyzToUv(int $face, S2Point $p) {
        if ($face < 3) {
            if ($p->get($face) <= 0) {
                return null;
            }
     ...
     * @return S2Point
     */
    public static function getUNorm(int $face, float $u) {
        switch ($face) {
            case 0:
     ...
     * @return S2Point
     */
    public static function getVNorm(int $face, float $v) {
        switch ($face) {
            case 0:
     ...
     * @return mixed
     */
    public static function getNorm(int $face) {
        return self::faceUvToXyz($face, 0, 0);
    }
