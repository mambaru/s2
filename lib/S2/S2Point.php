...
class S2Point
{
    ...
    public function crossProd(S2Point $p2) {
        return self::sCrossProd($this, $p2);
    }

    public static function sCrossProd(S2Point $a, S2Point $b) {
        return new S2Point(
            $a->y * $b->z - $a->z * $b->y,
            $a->z * $b->x - $a->x * $b->z,
            $a->x * $b->y - $a->y * $b->x
    ...
    public function ortho()
    {
        ...
        return S2Point::normalize($this->crossProd($temp));
    }
