...
class S2LatLngRect implements S2Region
{
     ...
     */
    public static function fullLng() {
     ...
     */
    public static function fromPointPair(S2LatLng $p1, S2LatLng $p2) {
...
//  }
    ...
    public function isFull() {
        return $this->lat->equals($this->fullLat()) && $this->lng->isFull();
    }
...
//  }
     ...
     * the given rectangle.
     */
    public function union(S2LatLngRect $other) {
