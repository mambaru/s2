...
//  }
     ...
     * </pre>
     */
  public function setMaxCells(int $maxCells) {
     ...
     * @return S2CellId[]
     */
    public function getCovering(S2Region $region)
    {
...
//        echo "child for " . $childCells[$i] . " is " . $child . "\n";
     ...
     */
      public function floodFill(S2Region $region, S2CellId $start) {
          $output = [];
          $all = [];
          $frontier = [];
          ...
          while (!empty($frontier)) {
               ...
               * @var S2CellId[]
               */
              $neighbors = $id->getEdgeNeighbors();

              foreach ($neighbors as $neighbor) {
                  $neighborCellId = $neighbor->id();//

                  if (!isset($all[$neighborCellId])) {
                      $frontier[] = $neighbor;
                      $all[$neighborCellId] = true;
                  }
              }
          }
