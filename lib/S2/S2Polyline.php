...
class S2Polyline implements S2Region
{
     ...
     * @return bool
     */
    public function mayIntersect($cell) {
        ...
        for ($j = 0; $j < 4; ++$j) {
            $crosser = new EdgeCrosser($cellVertices[$j], $cellVertices[($j + 1) & 3], $this->vertex(0));
